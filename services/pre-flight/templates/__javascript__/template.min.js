...
function template(){function e(a){return void 0===a||null===a?!1:0<=["boolean","number"].indexOf(typeof a)?a:a.__bool__ instanceof Function?a.__bool__()?a:!1:a.__len__ instanceof Function?0!==a.__len__()?a:!1:a instanceof Function?a:0!==x(a)?a:!1}function g(a){this.iterable=a;this.index=0}function f(a){this.iterable=a;this.index=0}function h(a,b,d){void 0==b&&(b=a,a=0);void 0==d&&(d=1);if(0<d&&a>=b||0>d&&a<=b)return[];for(var c=[];0<d?a<b:a>b;a+=d)c.push(a);return c}function w(a){if(null==a||"object"==
...
v){b=new Uint8Array(x(a));for(var d=0;d<x(a);d++)b[d]=a.charCodeAt(d);return b}if(b==l||b==p)return new Uint8Array(a);throw P;}function v(a){if("number"===typeof a)return a.toString();try{return a.__str__()}catch(b){try{return I(a)}catch(d){return String(a)}}}function Q(a){return this.hasOwnProperty(a)}function R(){var a=[],b;for(b in this)C(b)||a.push(b);return a}function S(){var a=[],b;for(b in this)C(b)||a.push([b,this[b]]);return a}function T(a){delete this[a]}function U(){for(var a in this)delete this[a]}
...
function(a){return x(a.__args__)?"{}{}".format(a.__class__.__name__,I(p(a.__args__))):"{}()".format(a.__class__.__name__)})},get __str__(){return m(this,function(a){return 1<x(a.__args__)?v(p(a.__args__)):x(a.__args__)?v(a.__args__[0]):""})}}),d=n("IterableError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return m(this,function(a,d){b.__init__(a,"Can't iterate over non-iterable",y({error:d}))})}}),c=n("StopIteration",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return m(this,
...
c,e],f):a.__setslice__(b,c,e,f)};(function(){var a=n("HandleRadioButtons",[t],{__module__:"__main__",get test(){return m(this,function(a){document.getElementById("test").style.display("block")})}}),b=a();c.HandleRadioButtons=a;c.__name__="__main__";c.handleRadioButtons=b})();return c}window.template=template();
