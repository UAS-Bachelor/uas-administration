...
c,e],f):a.__setslice__(b,c,e,f)};(function(){var a=n("HandleRadioButtons",[t],{__module__:"__main__",get test(){return m(this,function(a,b){document.getElementById(b).style.display="block"})}}),b=a();c.HandleRadioButtons=a;c.__name__="__main__";c.handleRadioButtons=b})();return c}window.template=template();
